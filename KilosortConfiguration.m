...
% Input: XMLfile - A character array containing the full path to the XML
%                  file generated by the Neuroscope. The file is used to
%                  load part of the recording metadata. This is a required
%                  input parameter.
...
%% Load XML and channel map files
% Loads xml parameters (Neuroscope)
xml = LoadXml(XMLfile); % a subfunction of KilosortWrapper
