...
function rezToPhy2_KSW(rez, savePath, varargin)
...
%
% Modified Kilosort subfunction rezToPhy2 by Martynas Dervinis
% (martynas.dervinis@gmail.com) at the Petersen Lab, University of
% Copenhagen.
...
if ~isempty(savePath)
    ...
    writeNPY(rez.ops.kcoords, fullfile(savePath, 'channel_shanks.npy')); % Added in rezToPhy2_KSW by MD
